      ...
      <SafeAreaView style={{ flex: 1, backgroundColor: '#FFFFFF' }}>
        <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 20 }}>
          ...
          <View style={{ width: '100%', alignItems: 'flex-start' }}>
            <Text style={{ fontSize: 18, textAlign: 'left', marginTop: 80, fontWeight: "bold", marginBottom: 32 }}>Welcome back!</Text>
          </View>
          <InputField
          ...
          <InputField
            ...
            // contaynerStyle={{ marginBottom: 32 }}
          ...
          <Button
            title={"Login"}
            containerStyle={{ width: 182, marginTop: 64 }}
            onPress={() => router.push("/home")}
            isLoading={false}
          />
            <Text style={{ fontSize: 14, gap:16,marginTop: 8 ,fontWeight: "600", marginBottom: 40}}>Register</Text>
