      ...
      <SafeAreaView style={{ flex: 1, backgroundColor: '#FFFFFF' }}>
        <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 20 }}>
          <View style={{ width: '100%', alignItems: 'flex-start' }}>
            <Text style={{ fontSize: 22, textAlign: 'left', marginTop: 80, ...FONTS['500'], marginBottom: 32 }}>Get Started!</Text>
          </View>
          ...
          <Text onPress={() => router.push("/")} style={{ fontSize: 14, gap: 16, marginTop: 8, ...FONTS['700'], marginBottom: 40 }}>Login</Text>
